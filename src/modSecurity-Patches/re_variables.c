...
static int var_custom_generate(modsec_rec *msr, msre_var *var, msre_rule *rule,
                               apr_table_t *vartab, apr_pool_t *mptmp)
{
    const apr_array_header_t *arr = NULL;
    const apr_table_entry_t *te = NULL;
    ...
    target_col = (apr_table_t *)apr_table_get(msr->collections, "custom");
    if (target_col == NULL) return 0;
    ...
    for (i = 0; i < arr->nelts; i++) {
        ...
        if (match) {
            ...
            rvar->value = str->value;
            rvar->value_len = str->value_len;
            rvar->name = apr_psprintf(mptmp, "CUSTOM:%s", log_escape_nq_ex(mptmp, str->name, str->name_len));
            apr_table_addn(vartab, rvar->name, (void *)rvar);
...
static int var_col_session_generate(modsec_rec *msr, msre_var *var, msre_rule *rule,
    apr_table_t *vartab, apr_pool_t *mptmp)
{
    const apr_array_header_t *arr = NULL;
    const apr_table_entry_t *te = NULL;
    ...
    target_col = (apr_table_t *)apr_table_get(msr->collections, "col_session");
    if (target_col == NULL) return 0;
    ...
    for (i = 0; i < arr->nelts; i++) {
        ...
        if (match) {
            ...
            rvar->value = str->value;
            rvar->value_len = str->value_len;
            rvar->name = apr_psprintf(mptmp, "COL_SESSION:%s", log_escape_nq_ex(mptmp, str->name, str->name_len));
            apr_table_addn(vartab, rvar->name, (void *)rvar);
...
static int var_col_csrf_generate(modsec_rec *msr, msre_var *var, msre_rule *rule,
    apr_table_t *vartab, apr_pool_t *mptmp)
{
    const apr_array_header_t *arr = NULL;
    const apr_table_entry_t *te = NULL;
    ...
    target_col = (apr_table_t *)apr_table_get(msr->collections, "col_csrf");
    if (target_col == NULL) return 0;
    ...
    for (i = 0; i < arr->nelts; i++) {
        ...
        if (match) {
            ...
            rvar->value = str->value;
            rvar->value_len = str->value_len;
            rvar->name = apr_psprintf(mptmp, "COL_CSRF:%s", log_escape_nq_ex(mptmp, str->name, str->name_len));
            apr_table_addn(vartab, rvar->name, (void *)rvar);
...
static int var_col_ua_generate(modsec_rec *msr, msre_var *var, msre_rule *rule,
    apr_table_t *vartab, apr_pool_t *mptmp)
{
    const apr_array_header_t *arr = NULL;
    const apr_table_entry_t *te = NULL;
    ...
    target_col = (apr_table_t *)apr_table_get(msr->collections, "col_ua");
    if (target_col == NULL) return 0;
    ...
    for (i = 0; i < arr->nelts; i++) {
        ...
        if (match) {
            ...
            rvar->value = str->value;
            rvar->value_len = str->value_len;
            rvar->name = apr_psprintf(mptmp, "COL_UA:%s", log_escape_nq_ex(mptmp, str->name, str->name_len));
            apr_table_addn(vartab, rvar->name, (void *)rvar);
