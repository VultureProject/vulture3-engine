...
void svm_csr_cross_validation(const struct svm_csr_problem *prob, const struct svm_parameter *param, int nr_fold,
                              double *target);
...
double
svm_csr_predict_probability(const struct svm_csr_model *model, const struct svm_csr_node *x, double *prob_estimates);
...
/*
 * \brief    Fill an svm_parameter structure
 * \details  Fill an svm_parameter structure with given value
 * \param    svm_parameter    The pointer to the structure to fill
 * \return
 */
...
/*
 * \brief    Create & return an instance of svm_model structure
 * \details  Create & return an instance of svm_model structure with given values
 * \param    svm_parameter    The svm_parameter struct previously filled with set_parameter
 * \return   svm_model        The svm_model structure filled up
 */
